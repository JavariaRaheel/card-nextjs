export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center h-screen p-6">
      <h1 className="text-6xl font-bold text-center">Welcome to HIJABEEZ HUB!</h1>

      <p className="text-center text-lg mt-4">
        Discover a curated collection of elegant hijabs and stylish accessories.
      </p>

      <section className="p-4 w-full max-w-2xl">
